		...
		<div id="navinfo">
			<marquee id="marqueehome"> 
					<ul>
						...
						<form>
							<span id="subtext">SUBSCRIBE TO OUR NEWSLETTER:  </span>
			...
			<div class="wrap">		
				<header>
					...
					<label for="slide-5-trigger"> Jobs </label>
					<label for="slide-6-trigger"> Visa </label>
					<label for="slide-7-trigger"> Vacations </label>

<div class="banner broch_banner">
		...
		<section class="aftertop">
			<span class="afnotactive"> <a href="index.html">Home</a> </span> >> <span class="afactive"> <a href="#">Career</a><span>
		...
		<section class="careerbody">
			...
			<div id="careerpositnwrap">
				<div>
					...
					<a href="marketingdept.html">	<button class="button"> Full Description</button> </a>
					</div>
					
					<div class="careerpositions">
						<h2>Reservation Officer</h2>
						<p> Ticketing and reservations department </p>
					<a href="reservationsdept.html">	<button class="button"> Full Description</button> </a>
					</div>
				
					<div class="careerpositions">
						<h2>Graphics Designer</h2>
						<p> Marketing and Sales department </p>
					<a href="careers_gd.html">	<button class="button"> Full Description</button> </a>
					</div>
